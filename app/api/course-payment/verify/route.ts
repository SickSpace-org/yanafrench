...
import { fulfillCoursePayment } from "@/lib/paymentFulfillment";
...
// course_payments/course_leads, and hands off to fulfillCoursePayment —
// the same function the Razorpay webhook calls (see
// app/api/webhooks/razorpay) — so this stays fulfilled exactly once
...
export async function POST(req: Request) {
  ...
  await fulfillCoursePayment(supabase, razorpay_order_id, razorpay_payment_id, leadId);
